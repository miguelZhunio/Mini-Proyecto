 ...
 * @author Usuario
 */
public class ElimProf extends javax.swing.JFrame {

    /**
     * Creates new form ElimProf
     */
    public ElimProf() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cbNivel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "POO", "BD", "INGLES", "ALGEBRA" }));
...
//            deshabilitarParametros();
            ...
            if (BuscarOpcion.getSelectedIndex() == 1) {
//                deshabilitarParametros();
                Profesor Ebuscar = new Profesor (null, null, null, null, null, null, null, null,null,null,null);
...
//                        habilitarParametros();
    ...
    public void BuscarParametros(ObjectContainer basep) throws ParseException {
        ...
        if (NombreAux == null && ApellidoAux == null && PaisAux == null && CorreoAux == null && ContraseñaAux == null && NivelAux == null) {
            ...
            Profesor Ebuscar = new Profesor ( NivelAux,null, NombreAux, ApellidoAux, PaisAux, CorreoAux, ContraseñaAux);
            ObjectSet result = basep.get(Ebuscar);
            MostrarDatos(result);
        }
    }
    ...
    public void Eliminar_Gerente(ObjectContainer basep) {
       ...
       Profesor Einterfaz = new Profesor();//Crear un objeto de la clase Estudiantes para traer el metodo Comprobar_Estudiantes
        ...
        if (txtCedulaC.getText().isEmpty()) {
            ...
            Profesor Leliminar = new Profesor (null, null,null, null,txtCedula.getText(), null, null, null, null,null);
            ObjectSet result = basep.get(Leliminar);

            if (Einterfaz.ConProfesor(basep, txtCedulaCo) == 0) {

                JOptionPane.showMessageDialog(null, "El estudiante no existe en la base de datos");

            } else {
                Profesor Estudianteeliminar = (Profesor) result.next();
...
//            java.util.logging.Logger.getLogger(ElimProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
